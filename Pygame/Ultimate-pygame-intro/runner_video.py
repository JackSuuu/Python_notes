...
# score_surface = test_font.render('Runner Tutorial', False, (64, 64, 64))  # 64 is the rgb
# score_rect = score_surface.get_rect(center=(300, 40))  # Use pygame rectangle to center the text
...
while True:
    ...
    if game_active:
        ...
        # pygame.draw.rect(screen, '#c0e8ec', score_rect)  # Draw a rectangle around text
        ...
        # Can do intro or menu
        screen.fill('#8ACFBA')
        screen.blit(player_stand, player_stand_rect)
        obstacle_rect_list.clear()
        # player.rectmidbottom = (80, 300)
